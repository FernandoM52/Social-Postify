...
describe('MediaController (e2e)', () => {
  ...
  describe("GET /medias", () => {
    it("Should return a empty array of medias when there are not medias created", async () => {
    ...
    it("Should return a array of medias when there are medias already created", async () => {
